...
- 📊 Detailed results visualization:
    ...
    - 🖼️ Visualization of each module (image, rarity, and attributes).
...
4.  ⚙️ **Initial Configuration in the Application**:
    ...
    -   🛡️ Choose the module type (Attack / Guard / Support / All).
...
- 📊 Visualización detallada de resultados:
    ...
    - 🖼️ Visualización de cada módulo (imagen, rareza y atributos).
...
4.  ⚙️ **Configuración inicial en la aplicación**:
    ...
    -   🛡️ Elige el tipo de módulo (Attack / Guard / Support / All).
...
1.  Python 3.8 o superior: If you don't have Python installed, download it from the official website: [python.org](https://www.python.org/downloads/). Make sure to check the "Add Python to PATH" option during installation.
2.  Npcap: Es necesario instalar Npcap para que la aplicación pueda capturar tráfico de red del juego.
    - Download the Npcap installer (se recomienda la versión npcap-1.83 o superior) from [npcap.com](https://npcap.com/#download).
